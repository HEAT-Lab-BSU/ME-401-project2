...
|------|------|-------------|
| `report.pdf` | Technical Report | Full write-up of methodology, analysis, and results |
| `presentation.pdf` | Slide Deck | Summary of process and key engineering outcomes |
